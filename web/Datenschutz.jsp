...
<div id="container">
    ...
    <div id="d2">
        ...
        <h3>Hinweis zur verantwortlichen Stelle</h3> <p>Die verantwortliche Stelle f&uuml;r die Datenverarbeitung auf dieser Website ist:</p> <p>TicTacToe<br />
        Rue Fernand Houget 14b<br />
        4800 Verviers<br />
        Belgium</p>

        <p>Telefon: +49 (0) 123 44 55 66<br />
            E-Mail: Team@tac.toe</p>
