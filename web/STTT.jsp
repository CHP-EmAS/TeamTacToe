...
<div id="container">
    ...
    <div id="d2">
        ...
        <br><br>
        <button class="fieldButton" id="field28" onclick="fieldClick(28)"></button><button class="fieldButton" id="field29" onclick="fieldClick(29)"></button><button class="fieldButton" id="field30" onclick="fieldClick(30)"></button>&nbsp<button class="fieldButton" id="field37" onclick="fieldClick(37)"></button><button class="fieldButton" id="field38" onclick="fieldClick(38)"></button><button class="fieldButton" id="field39" onclick="fieldClick(39)"></button>&nbsp<button class="fieldButton" id="field46" onclick="fieldClick(46)"></button><button class="fieldButton" id="field47" onclick="fieldClick(47)"></button><button class="fieldButton" id="field48" onclick="fieldClick(48)"></button>
        <br>
